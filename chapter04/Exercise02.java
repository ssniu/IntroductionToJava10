 ...
 */
 ...
 class Exercise02{
   public static void main(String[] args){
     ...
     final double RADIUS = 6371.01;// Set the radius to be a constant
     // Enter the latitude and longitude of two points as strings
     ...
     double r = Math.sin(x1) * Math.sin(x2) +
           Math.cos(x1) * Math.sin(x2) * Math.cos(y1 - y2);
     double d;
     d = RADIUS * Math.acos(r);
